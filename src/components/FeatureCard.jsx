export default function FeatureCard({ title, description }) {
  return (
    <div className="group bg-white/70 backdrop-blur-md shadow-2xl p-8 rounded-2xl text-center transform transition-transform duration-500 hover:scale-105 hover:shadow-3xl overflow-hidden relative">
